...
export default function ProjectsComponent({innerRef}:{innerRef:React.MutableRefObject<null>}) {
  ...
  return (
    <div className="min-h-screen min-w-full text-slate-200 flex justify-center pt-12 snap-center" ref={innerRef} id="Projects">
      <div className="flex-1 max-w-4xl">
        <h2 className="text-2xl font-bold  text-slate-100 p-3 m-4 rounded-xl underline underline-offset-8 decoration-indigo-500" key={"Header"}>
          My Projects
        </h2>
